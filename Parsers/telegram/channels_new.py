...
api_id = 1714000
api_hash = '6d7a67fc87c94dbeb6a934923cf9a200'
username = ' lisa_maratova'
...
url = ['Uzynqulaq',
       ...
       'oyanqazaqstan',
       'basekz',
       ]#input("Введите ссылку на канал или чат: ")
...
def insert_into_postgres(m):
    ...
    cur.execute("""select id from TL_MEDIA_CHANNELS_TGM_2W where object_id = \'{}\' and channel_id=\'{}\'""".format(object_id, channel_id))
