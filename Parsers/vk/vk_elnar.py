...
def get_channels():
    ...
    cursor = con.cursor()
    sql = 'select channel_id from tl_media_channels where source_id = 1 order by id limit(18) offset(90)'
...
access_token = '68a17e9b5e5eabef13fb5db5e337344df17874ebdda0c77fb9a199deea57a1f4acb359a7ce133ed8d6126'

while True:
    bot_message = "VkElnar RUNNING" + "  " + str(datetime.datetime.now())
    ...
    #        print(all_comments)
        ...
        bot_message = "VkElnar ERROR" + "  " + str(datetime.datetime.now())
        telegram_bot_sendtext(bot_message)
