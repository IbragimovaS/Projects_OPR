...
def get_channels():
    ...
    cursor = con.cursor()
    sql = 'select channel_id from tl_media_channels where source_id = 1 order by id limit(18) offset(36)'
...
access_token = 'f438670e564cb1e747993c8b24600456ee924cf5e5f0e62f9b32f3e8698ff5537c93928c2ada1a0df9cde'


while True:
    bot_message = "VkRuslan RUNNING" + "  " + str(datetime.datetime.now())
    ...
    #        print(all_comments)
        ...
        bot_message = "VkRuslan ERROR" + "  " + str(datetime.datetime.now())
        telegram_bot_sendtext(bot_message)
