...
def get_channels():
    ...
    cursor = con.cursor()
    sql = 'select channel_id from tl_media_channels where source_id = 1 order by id limit(18) offset(18)' #95
...
access_token = 'fa1b6d2cc034963498d5b55a71031660eb2b226a2f27c3bd81d5b867e4ea73b9b8ab4f4fceade2681c782'

while True:
    bot_message = "VkSultan RUNNING" + "  " + str(datetime.datetime.now())
    ...
    #        print(all_comments)
        ...
        bot_message = "VkSultan ERROR" + "  " + str(datetime.datetime.now())
        telegram_bot_sendtext(bot_message)
