...
def get_channels():
    ...
    cursor = con.cursor()
    sql = 'select channel_id from tl_media_channels where source_id = 1 order by id limit(40) offset(95)' #95
...
def get_date(date):
    new_date = datetime.datetime(2019, 1, 1, 0, 0)#date - datetime.timedelta(days=5)
...
access_token = '952a831e03d683ecaa299cb28c153e71c5e77604e15ff49564490030fa392aec82b63f901c4a712f2396b'
