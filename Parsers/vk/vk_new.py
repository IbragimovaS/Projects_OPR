...
def get_channels():
    ...
    cursor = con.cursor()
    sql = 'select channel_id from tl_media_channels where id = 1150'
...
access_token = '76c1544038783444cf919eea9b079d2519e90ff0e92b547a3e2dd851732695534593ef696f946e03a7b9a'
...
while True:
    ...
    #        print(all_comments)
        ...
        bot_message = "VkAli ERROR" + "  " + str(datetime.datetime.now())
        telegram_bot_sendtext(bot_message)
