...
def get_channels():
    ...
    cursor = con.cursor()
    sql = 'select channel_id from tl_media_channels where source_id = 1 order by id limit(18) offset(72)'
...
access_token = '719c90ab3ca9986a6ef7c56d6f9e5884b5a6c7e13de1f618d887e29685fe0f33efe8810886cec3fdb2754'

while True:
    bot_message = "VkErkin RUNNING" + "  " + str(datetime.datetime.now())
    ...
    #        print(all_comments)
        ...
        bot_message = "VkErkin ERROR" + "  " + str(datetime.datetime.now())
        telegram_bot_sendtext(bot_message)
