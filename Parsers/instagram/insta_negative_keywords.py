...
cursor = con.cursor()
try:
    bot_message = "InstaNegativeKeywords Running" +  "  " +  str(datetime.datetime.now())
    ...
    bot_message = "InstaNegativeKeywords ERROR" +  "  " +  str(datetime.datetime.now())
    telegram_bot_sendtext(bot_message)
