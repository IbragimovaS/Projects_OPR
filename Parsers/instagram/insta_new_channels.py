...
def get_channels():
    ...
    cursor = con.cursor()
    sql = "select channel_id from tl_media_channels where channel_id in ('1911866085')"
...
channel_id = {'1473893994', '7627271817', '571284728'}

connection_text = "DATABASE=PRODDB;HOSTNAME=192.168.252.11;PORT=50000;PROTOCOL=TCPIP;UID=db2inst1;PWD=Qjuehnghj1;"
con = db.connect(connection_text, "", "")
cursor = con.cursor()
try:
    bot_message = "InstaPosivive1111 Running" +  "  " +  str(datetime.datetime.now())
    ...
    for id in channel_id:
        ...
        SINCE = datetime.datetime.now() - datetime.timedelta(days=188)
        UNTIL = SINCE - datetime.timedelta(days=405)
        print(SINCE, '  ', UNTIL)
    ...
    bot_message = "InstaNewChannels ERROR" +  "  " +  str(datetime.datetime.now())
    telegram_bot_sendtext(bot_message)
