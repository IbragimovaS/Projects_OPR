...
def get_channels():
    ...
    cursor = con.cursor()
    sql = 'select channel_id from tl_media_channels where source_id = 2 order by id limit(30) offset(120)'
...
bot_message = "InstaPosivive40 Running" +  "  " +  str(datetime.datetime.now())
...
try:
    ...
    bot_message = "InstaPositive40 ERROR" +  "  " +  str(datetime.datetime.now())
    telegram_bot_sendtext(bot_message)
